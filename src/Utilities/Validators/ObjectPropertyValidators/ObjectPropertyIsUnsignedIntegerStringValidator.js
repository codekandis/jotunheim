...
/**
 * Represents an object validator validating if an object's property is a string representation of an unsigned integer.
 * @author Christian Ramelow <info@codekandis.net>
 */
export class ObjectPropertyIsUnsignedIntegerStringValidator extends ObjectPropertyWithInnerValidatorValidator
{
	/**
	 * Constructor method.
	...
	/**
	 * @inheritdoc
	 * Validates if the object's property is a string representation of an unsigned integer.
	 */
	validate()
	{
