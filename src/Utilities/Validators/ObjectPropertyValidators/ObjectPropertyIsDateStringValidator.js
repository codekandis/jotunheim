...
/**
 * Represents an object validator validating if an object's property is a string representation of a date.
 * @author Christian Ramelow <info@codekandis.net>
 */
export class ObjectPropertyIsDateStringValidator extends ObjectPropertyWithInnerValidatorValidator
{
	/**
	 * Constructor method.
	...
	/**
	 * @inheritdoc
	 * Validates if the object's property is a string representation of a date.
	 */
	validate()
	{
