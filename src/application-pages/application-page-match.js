...
export class ApplicationPageMatch extends Abstract
{
	 ...
	 * @returns {function(new:TApplicationPageClass, ...any): TApplicationPageClass} The application page class.
	 */
	 ...
	 * @returns {Record<string, string>} The application page arguments.
	 */
