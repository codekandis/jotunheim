...
/**
 * Represents an HTML element validator validating if a value is an unsigned float.
 * @author Christian Ramelow <info@codekandis.net>
 */
export class HtmlElementIsUnsignedFloatValidator extends AbstractHtmlElementValidator
{
	/**
	...
	constructor( htmlElement, propertyName )
	{
		...
		this.#_innerValidator = new IsUnsignedFloatValidator();
	}
