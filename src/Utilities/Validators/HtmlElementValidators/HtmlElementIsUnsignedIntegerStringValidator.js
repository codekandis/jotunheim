...
/**
 * Represents an HTML element validator validating if a value is a string representation of an unsigned integer.
 * @author Christian Ramelow <info@codekandis.net>
 */
export class HtmlElementIsUnsignedIntegerStringValidator extends AbstractHtmlElementValidator
{
	/**
	...
	constructor( htmlElement, propertyName )
	{
		...
		this.#_innerValidator = new IsUnsignedIntegerStringValidator();
	}
