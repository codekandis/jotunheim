 ...
 */
export class HtmlElementIsStringInRangeValidator extends AbstractHtmlElementValidator
{
	/**
	...
	constructor( htmlElement, propertyName, minValue, maxValue, isInclusive )
	{
		...
		this.#_innerValidator = new IsStringInRangeValidator( minValue, maxValue, isInclusive );
	}
