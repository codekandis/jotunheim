...
/**
 * Represents an object validator validating if an object's property is a boolean.
 * @author Christian Ramelow <info@codekandis.net>
 */
export class ObjectPropertyIsBooleanValidator extends ObjectPropertyWithInnerValidatorValidator
{
	/**
	 * Constructor method.
	...
	/**
	 * @inheritdoc
	 * Validates if the object's property is a boolean.
	 */
	validate()
	{
